...
while ensemble <1 :
    ...
    Blue = '-10'      ##### -3,-4,-5 ---->Blue == j @ j = -1
    Somon = '9'    ##### 1,3,4,5 -----> Somon = k @ k = 0
    Pink = '-9'      ###### 2,3,4 ----> Pink = ij @ ij = 0
    Green= '-7'      ##### 1,-1,-2,-3 ----> Green = j @ j = 2
                            ...
                            while  k  < Somon :###### X KiJ X
                              ...
                              #  j = 5
                                ...
                                while j < k:
                                  ...
                                  #  Yellow = yellow
                                    while k <  i:
                                      ...
                                      #          z = -ik+1
                                          ...
                                          #      if ik == jk:
                                            ...
                                            if  ik == white:
                                                ...
                                                if (OfX == x and OfY == y and OfX == z and OfY == w and ( a!='M' or (c == 'E' and b == 'W')) ):#and c == '¬E') ):
                                      ...
                                      #      print(Yellow)
                                            k = int(somon)
                                            if (OfX == z and OfY == y and OfX == x) and (OfY == w+1 or OfY == w-1) and ((a != 'M' or b == '¬W') and (a != '¬M' or b == 'W')) :
                                   ...
                                   #  
                                    ...
                                    if j == Blue:
                                        ...
                                        if ( OfX == x and OfY == y ) and (OfX == z+1 or  OfX == z-1) and ((a != 'M' or c == '¬E') and (a != '¬M' or c == 'E')):# and b != '¬E':
                                ...
                                if k != i :
                                   ...
                                   i -= 1
                                   if ( OfX == x and OfY == y and  a =='M' and  ((b == '¬W' and c == '¬E') or (c == 'E' and b == 'W'))) :
                                       print(i,'i')
